...
<head>
    <head>
        ...
        <title>Eartistic System | New Dealer Invoice</title>
...
<?php
									...
									$id = $_SESSION['id'];
									$id = $_GET['id'];
									$view = "SELECT * from dealer where md5(dealer_id) = '$id'";
...
?>
  ...
  <table cellpadding="3" cellspacing="0">
    ...
    <tr>
      ...
      <td><input name="name" value="<?php echo $row['dealer_name']; ?>"  size="20"   />
	  <td><strong>Address 1</strong></td>
      <td><input name="invoice_ic" value="<?php echo $row['dealer_address1']; ?>"  size="20"   />
      <td><strong>Address 2</strong></td>
      <td><input name="invoice_hospital" value="<?php echo $row['dealer_address2']; ?>" size="20" />
</td>
