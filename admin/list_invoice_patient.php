    ...
    <table bgcolor="white" width="100%" align="center" border="1" cellpadding="5" cellspacing="0" class="example table-autosort:0 table-stripeclass:alternate" >
        <thead>     
                ...
                <th class='table-sortable:numeric table-sortable table-sorted-asc' width='10' style="cursor:pointer">No</th>               
                     <th class='table-sortable:numeric table-sortable table-sorted-asc' width='50' style="cursor:pointer">Invoice No</th>
                 <th width="100" class='table-sortable:default table-sortable' style="cursor:pointer">Name</th>
                 <th width="100" class='table-sortable:default table-sortable' style="cursor:pointer">Date</th>       
