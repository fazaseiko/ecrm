...
?>
                  ...
                  <td width="71%"><label for="select"></label>
                    ...
                    <select name="forma" onchange="location = this.options[this.selectedIndex].value;">
                      <option value="new_invoice_patient.php">Patient</option>
                      <option value="new_invoice_dealer.php">Dealer</option>
                      <option value="new_invoice_funder.php">Funder</option>
                    </select>
                  </span></td>
                </tr>
    ...
    <table bgcolor="white" width="100%" align="center" border="1" cellpadding="5" cellspacing="0" class="example table-autosort:0 table-stripeclass:alternate" >
        <thead>     
                ...
                <th class='table-sortable:numeric table-sortable table-sorted-asc' width='10' style="cursor:pointer">No</th>            
                     <th class='table-sortable:numeric table-sortable table-sorted-asc' width='50' style="cursor:pointer">Patient</th>
                 <th width="100" class='table-sortable:default table-sortable' style="cursor:pointer">IC Number</th>       
                 <th width="80" class='table-sortable:default table-sortable' >Actions</th>                         
            </tr>
        </thead>
<tbody>
<!-----------------------------------Content------------------------------------>
<?php
        ...
        <tr align="center">
            ...
            <td><a href="add_invoice_patient.php?id=<?php echo md5($row['patient_id']);?>"> new invoice</a>
            </td>
