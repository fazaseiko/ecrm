...
<head>
    <head>
        ...
        <title>Eartistic System| New Sale</title>
                               ...
                               <form class="form-horizontal row-fluid" action="action/new-sales.php" method="POST">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select here.." class="span4" name="product1">
                                                   ...
                                                   while($row = $result->fetch_assoc()) {
                                                       print '<option value="'.$row['item_description'].'">'.$row['item_description'].'</option>';
                                                         }
                                                    } else {
                                                ...
                                                <select tabindex="1" data-placeholder="Select here.." class="span4" name="patient1">
													<option value="">Patient Name..</option>
										            <?php
													include '../config/db_config.php';
								 
								                     $sql = "SELECT * FROM patient ORDER BY patient_name";
                                                     $result = $conn->query($sql);
                                  
								                    if ($result->num_rows > 0) {
    
                                                   while($row = $result->fetch_assoc()) {
                                                       print '<option value="'.$row['patient_id'].'">'.$row['patient_name'].'</option>';
                                                         }
                                                    } else {
										...
										<div class="control-group">
											...
											<div class="controls">
                                                ...
                                                <select tabindex="1" data-placeholder="Select here.." class="span4" name="patient3">
													<option value="">Patient Name..</option>
										            <?php
													include '../config/db_config.php';
